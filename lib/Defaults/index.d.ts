...
/** Mobile WebSocket endpoint host */
export declare const MOBILE_ENDPOINT = "g.whatsapp.net";
/** Mobile WebSocket endpoint port */
export declare const MOBILE_PORT = 443;
/** Noise protocol header for mobile connections (WA v5.2) */
...
/** Base URL for WhatsApp mobile registration API */
export declare const MOBILE_REGISTRATION_ENDPOINT = "https://v.whatsapp.net/v2";
/** User-Agent header used in mobile registration requests */
export declare const MOBILE_USERAGENT: string;
/** WhatsApp public key used for mobile registration payload encryption */
