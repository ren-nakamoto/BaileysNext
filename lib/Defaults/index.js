...
// ─── Mobile / Registration constants ──────────────────────────────────────────
// These are required by lib/Socket/socket.js and lib/Socket/registration.js
exports.MOBILE_ENDPOINT = 'g.whatsapp.net';
exports.MOBILE_PORT = 443;
/** Noise protocol header for mobile connections: "WA" + version 5.2 */
exports.MOBILE_NOISE_HEADER = Buffer.from([87, 65, 5, 2]);
/** Token used when building the mobile registration hash */
exports.MOBILE_TOKEN = Buffer.from('0a1mLfGUIBVrMKF1RdvLI5lkRBvof6vn0fD2QRSM');
exports.MOBILE_REGISTRATION_ENDPOINT = 'https://v.whatsapp.net/v2';
exports.MOBILE_USERAGENT = 'WhatsApp/2.24.6.84 A';
/** WhatsApp's public key used for mobile registration encryption */
exports.REGISTRATION_PUBLIC_KEY = Buffer.from([
    5, 142, 140, 15, 116, 195, 235, 197, 215, 166, 134, 92, 108, 60, 132, 56,
    86, 176, 97, 33, 204, 232, 234, 119, 77, 34, 251, 111, 18, 37, 180, 249, 77
]);
