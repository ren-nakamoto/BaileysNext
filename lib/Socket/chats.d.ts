...
export declare const makeChatsSocket: (config: SocketConfig) => {
    ...
    /** Search messages on WA servers. Returns snippets with key + timestamp. */
    searchMessages: (query: string, jid?: string, count?: number, page?: number) => Promise<{
        key: { remoteJid: string; id: string; fromMe: boolean };
        snippet: string;
        timestamp: number | undefined;
    }[]>;
    /** Search contacts registered on WhatsApp by name or number fragment. */
    searchContacts: (query: string, count?: number) => Promise<{
        jid: string;
        name?: string;
        phone: string;
    }[]>;
